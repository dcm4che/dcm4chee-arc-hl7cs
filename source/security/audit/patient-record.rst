...
This message is emitted by the archive on :
- receive of HL7 messages :
    - `ADT Patient Management messages <https://dcm4chee-arc-hl7cs.readthedocs.io/en/latest/adt/inbound.html#inbound-messages>`_
...
- Invocation of `ADT Patient Management <https://dcm4chee-arc-hl7cs.readthedocs.io/en/latest/adt/inbound.html#inbound-messages>`_
  changes in external archive.
- Notification to HL7 receivers on `ADT Patient Management <https://dcm4chee-arc-hl7cs.readthedocs.io/en/latest/adt/inbound.html#inbound-messages>`_
  changes in own archive.
